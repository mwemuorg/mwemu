...
// VROUNDSD dest, src1, src2, imm8: low round(src2); [127:64] from src1.
pub fn execute(emu: &mut Emu, ins: &Instruction, _s: usize, _r: bool) -> bool {
    ...
    let x = f64::from_bits((s2 & 0xffff_ffff_ffff_ffff) as _);
    let v = match m {
        0 => x.round_ties_even(),
        1 => x.floor(),
        2 => x.ceil(),
    ...
    emu.set_operand_xmm_value_128(
        ins,
        0,
        (s1 & !(0xffff_ffff_ffff_ffff as u128)) | (v.to_bits() as u128),
    );
    true
}
