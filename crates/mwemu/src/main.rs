...
fn main() -> process::ExitCode {
    let matches = App::new("MWEMU emulator for malware")
        ...
        .arg(clap_arg!("winver", "", "winver", "fetch genuine system DLLs from Microsoft's symbol server on demand instead of an ISO; accepts a friendly name (win11 is the recommended stable base; also win11@22h2, win11@21h2, win10, win2019) or an exact build (26100.7920). e.g. --winver win11", "VERSION"))
